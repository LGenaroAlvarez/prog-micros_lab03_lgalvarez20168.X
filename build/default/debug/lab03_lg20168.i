...
CLK_CONFIG: ; CONFIGURACIÓN DEL OSCILADOR
    ...
    BSF ((OSCCON) and 07Fh), 4 ; BIT 4 DE OSCCON EN 1
    BCF ((OSCCON) and 07Fh), 5 ; BIT 5 DE OSCCON EN 0
...
TMR0_CONFIG: ; CONFIGURACIÓN DEL TMR0
    ...
    BSF ((OPTION_REG) and 07Fh), 0 ; ((OPTION_REG) and 07Fh), 0 EN 1 -> 111 = PRESCALER 1:256
    BCF ((OPTION_REG) and 07Fh), 5 ; TMR0 MODO TIMER
...
TMR0_LOOP:
    BTFSS ((INTCON) and 07Fh), 2 ; REVISAR BANDERA OVERFLOW DEL TMR0
    GOTO TMR0_LOOP
...
INC_CONT:
    BTFSC PORTB, 0 ; REVISAR SI EL BOTON YA NO ESTA PRESIONADO (SI EL VALOR DEL PIN ((PORTB) and 07Fh), 0 ES 0) SI ES 1 MANTENER EL LOOP
    GOTO $-1
...
DEC_CONT:
    BTFSC PORTB, 1 ; REVISAR SI EL BOTON YA NO ESTA PRESIONADO (SI EL VALOR DEL PIN ((PORTB) and 07Fh), 1 ES 0) SI ES 1 MANTENER EL LOOP
    GOTO $-1
