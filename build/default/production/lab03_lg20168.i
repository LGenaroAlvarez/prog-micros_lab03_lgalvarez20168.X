...
loop:
    BTFSC ((PORTB) and 07Fh), 0 ; REVISAR SI EL PIN 0 DEL PORTB ESTA ACTIVADO, SI NO, SALTAR LA INSTRUCCION SIGUIENTE
    CALL INC_CONT ; ACCEDER SUBRUTINA DE INCREMENTO
    BTFSC ((PORTB) and 07Fh), 1 ; REVISAR SI EL PIN 1 DEL PORTB ESTÁ ACTIVADO, SI NO, SALTAR LA INSTRUCCION SIGUIENTE
