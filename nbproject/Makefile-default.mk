...
FINAL_IMAGE=${DISTDIR}/prog-micros_lab03_lg20168.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=prelab_03.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/prelab_03.o
POSSIBLE_DEPFILES=${OBJECTDIR}/prelab_03.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/prelab_03.o

# Source Files
SOURCEFILES=prelab_03.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/prog-micros_lab03_lg20168.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/prog-micros_lab03_lg20168.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/prog-micros_lab03_lg20168.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/prog-micros_lab03_lg20168.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
